...
class RecordsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.records_field_get_endpoint = _Endpoint(
            settings={
                'response_type': ([RecordsResponse],),
                'auth': [],
                'endpoint_path': '/records/{field}',
                'operation_id': 'records_field_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def records_field_get(
        ...
        **kwargs
        ...
        kwargs['field'] = \
            field
        return self.records_field_get_endpoint.call_with_http_info(**kwargs)
