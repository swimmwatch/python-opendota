...
class ProMatchesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.pro_matches_get_endpoint = _Endpoint(
            settings={
                'response_type': ([MatchObjectResponse],),
                'auth': [],
                'endpoint_path': '/proMatches',
                'operation_id': 'pro_matches_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def pro_matches_get(
        ...
        **kwargs
        ...
        return self.pro_matches_get_endpoint.call_with_http_info(**kwargs)
