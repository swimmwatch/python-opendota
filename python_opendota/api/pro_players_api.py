...
class ProPlayersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.pro_players_get_endpoint = _Endpoint(
            settings={
                'response_type': ([PlayerObjectResponse],),
                'auth': [],
                'endpoint_path': '/proPlayers',
                'operation_id': 'pro_players_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def pro_players_get(
        ...
        **kwargs
        ...
        return self.pro_players_get_endpoint.call_with_http_info(**kwargs)
