...
class MatchObjectResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MatchObjectResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            match_id (int): Used to identify individual matches, e.g. 3703866531. [optional]  # noqa: E501
            duration (int): Length of the match. [optional]  # noqa: E501
            start_time (int): Unix timestamp of when the match began. [optional]  # noqa: E501
            radiant_team_id (int): The Radiant's team_id. [optional]  # noqa: E501
            radiant_name (str): The Radiant's team name. [optional]  # noqa: E501
            dire_team_id (int): The Dire's team_id. [optional]  # noqa: E501
            dire_name (str): The Dire's team name. [optional]  # noqa: E501
            leagueid (int): Identifier for the league the match took place in. [optional]  # noqa: E501
            league_name (str): Name of league the match took place in. [optional]  # noqa: E501
            series_id (int): Identifier for the series of the match. [optional]  # noqa: E501
            series_type (int): Type of series the match was. [optional]  # noqa: E501
            radiant_score (int): Number of kills the Radiant team had when the match ended. [optional]  # noqa: E501
            dire_score (int): Number of kills the Dire team had when the match ended. [optional]  # noqa: E501
            radiant_win (bool): Whether or not the Radiant won the match. [optional]  # noqa: E501
