...
class SchemaFor200ResponseBodyApplicationJson(schemas.DictSchema):
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        lose: typing.Union[
            MetaOapg.properties.lose, decimal.Decimal, int, schemas.Unset
        ] = schemas.unset,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _players_account_id_wl_get_oapg(
        self,
...
class PlayersAccountIdWlGet(BaseApi):
    ...
    def players_account_id_wl_get(
        ...
        return self._players_account_id_wl_get_oapg(
