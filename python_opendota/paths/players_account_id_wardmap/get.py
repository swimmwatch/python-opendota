...
class SchemaFor200ResponseBodyApplicationJson(schemas.DictSchema):
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        obs: typing.Union[
            MetaOapg.properties.obs, dict, frozendict.frozendict, schemas.Unset
        ] = schemas.unset,
        sen: typing.Union[
            MetaOapg.properties.sen, dict, frozendict.frozendict, schemas.Unset
        ] = schemas.unset,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _players_account_id_wardmap_get_oapg(
        self,
...
class PlayersAccountIdWardmapGet(BaseApi):
    ...
    def players_account_id_wardmap_get(
        ...
        return self._players_account_id_wardmap_get_oapg(
