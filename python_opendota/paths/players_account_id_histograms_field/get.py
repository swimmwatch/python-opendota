...
class BaseApi(api_client.Api):
    @typing.overload
    def _players_account_id_histograms_field_get_oapg(
        self,
...
class PlayersAccountIdHistogramsFieldGet(BaseApi):
    ...
    def players_account_id_histograms_field_get(
        ...
        return self._players_account_id_histograms_field_get_oapg(
