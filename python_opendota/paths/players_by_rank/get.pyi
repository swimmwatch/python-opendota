    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        account_id: typing.Union[
            MetaOapg.properties.account_id, decimal.Decimal, int, float, schemas.Unset
        ] = schemas.unset,
...
class PlayersByRankGet(BaseApi):
    ...
    def players_by_rank_get(
        ...
        return self._players_by_rank_get_oapg(
