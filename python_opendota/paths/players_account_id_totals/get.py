...
class SchemaFor200ResponseBodyApplicationJson(schemas.ListSchema):
    class MetaOapg:
        class items(schemas.DictSchema):
            ...
            @typing.overload
            def __getitem__(
                self, name: typing_extensions.Literal["n"]
            ) -> MetaOapg.properties.n:
                ...
            ...
            def get_item_oapg(
                self, name: typing_extensions.Literal["n"]
            ) -> typing.Union[MetaOapg.properties.n, schemas.Unset]:
                ...
            ...
            def __new__(
                ...
                *_args: typing.Union[
                ...
                n: typing.Union[
                    MetaOapg.properties.n, decimal.Decimal, int, schemas.Unset
                ] = schemas.unset,
                sum: typing.Union[
                    MetaOapg.properties.sum, decimal.Decimal, int, schemas.Unset
                ] = schemas.unset,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _players_account_id_totals_get_oapg(
        self,
...
class PlayersAccountIdTotalsGet(BaseApi):
    ...
    def players_account_id_totals_get(
        ...
        return self._players_account_id_totals_get_oapg(
