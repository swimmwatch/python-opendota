        ...
        class items(schemas.DictSchema):
            class MetaOapg:
                class properties:
                    ...
                    percent_rank = schemas.NumberSchema
                    card = schemas.IntSchema
                    __annotations__ = {
                        "hero_id": hero_id,
                        "score": score,
            ...
            @typing.overload
            def __getitem__(
                self, name: typing_extensions.Literal["percent_rank"]
            ) -> MetaOapg.properties.percent_rank:
                ...

            @typing.overload
            def __getitem__(
                self, name: typing_extensions.Literal["card"]
            ) -> MetaOapg.properties.card:
                ...
            ...
            def get_item_oapg(
                self, name: typing_extensions.Literal["percent_rank"]
            ) -> typing.Union[MetaOapg.properties.percent_rank, schemas.Unset]:
                ...

            @typing.overload
            def get_item_oapg(
                self, name: typing_extensions.Literal["card"]
            ) -> typing.Union[MetaOapg.properties.card, schemas.Unset]:
                ...
            ...
            def __new__(
                ...
                *_args: typing.Union[
                ...
                card: typing.Union[
                    MetaOapg.properties.card, decimal.Decimal, int, schemas.Unset
                ] = schemas.unset,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _players_account_id_rankings_get_oapg(
        self,
...
class PlayersAccountIdRankingsGet(BaseApi):
    ...
    def players_account_id_rankings_get(
        ...
        return self._players_account_id_rankings_get_oapg(
