...
# Query params
LessThanMatchIdSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        "less_than_match_id": typing.Union[
...
request_query_less_than_match_id = api_client.QueryParameter(
    name="less_than_match_id",
    style=api_client.ParameterStyle.FORM,
    schema=LessThanMatchIdSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _pro_matches_get_oapg(
        ...
        for parameter in (request_query_less_than_match_id,):
...
class ProMatchesGet(BaseApi):
    ...
    def pro_matches_get(
        ...
        return self._pro_matches_get_oapg(
