...
class Configuration(object):
    ...
    conf = python_opendota.Configuration(
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "http://api.opendota.com/api" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("python_opendota")
