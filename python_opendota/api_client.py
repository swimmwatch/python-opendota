...
from python_opendota import rest
from python_opendota.configuration import Configuration
from python_opendota.exceptions import ApiTypeError, ApiValueError, ApiException
from python_opendota.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BenchmarksApi()
        api_instance.benchmarks_get  # this is an instance of the class Endpoint
        api_instance.benchmarks_get()  # this invokes api_instance.benchmarks_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.benchmarks_get.callable or self.callable in this class
